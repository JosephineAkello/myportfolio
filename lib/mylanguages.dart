                      ...
                      child: Column(mainAxisSize: MainAxisSize.min, children: [
                        Padding(
                          ...
                          child: LinearPercentIndicator(
                            ...
                            width: 140.0,
                            lineHeight: 20.0,
                            leading: Text('Dart',style: TextStyle(
                fontSize: 16,
                color: Color(0xFFcaadde),
                        ...
                        Padding(
                          ...
                          child: LinearPercentIndicator(
                            ...
                            width: 140.0,
                            lineHeight: 20.0,
                            leading: Text('Flutter',style: TextStyle(
                fontSize: 16,
                color: Color(0xFFcaadde),
              ),),
                            percent: 0.7,
                        ...
                        Padding(
                          ...
                          child: LinearPercentIndicator(
                            ...
                            lineHeight: 20.0,
                            percent: 0.5,
                            leading: Text('Elixir',style: TextStyle(
                fontSize: 16,
                color: Color(0xFFcaadde),
              ),),
                        ...
                        Padding(
                          ...
                          child: LinearPercentIndicator(
                            ...
                            lineHeight: 20.0,
                            percent: 0.7,
                            leading: Text('HTML/CSS',style: TextStyle(
                fontSize: 16,
                color: Color(0xFFcaadde),
              ),),
                            center: Text("70.0%"),
                        ...
                        Padding(
                          ...
                          child: LinearPercentIndicator(
                            ...
                            lineHeight: 20.0,
                            percent: 0.6,
                            leading: Text('JavaScript',style: TextStyle(
                fontSize: 16,
                color: Color(0xFFcaadde),
              ),),
                            center: Text("60.0%"),
                        ...
                        Padding(
                          ...
                          child: LinearPercentIndicator(
                            ...
                            lineHeight: 20.0,
                            percent: 0.3,
                            leading: Text('C#',style: TextStyle(
                fontSize: 16,
                color: Color(0xFFcaadde),
              ),),
                            center: Text("30.0%"),
